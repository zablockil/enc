#!/bin/bash
# key scheme: C + S + E
# faketime "2024-01-01 12:00:00" ./clean_RSA-PSS_dual-key.sh
...
### BEGIN SMIME dual-key [RSA-PSS] ROOT x509v3_config
...
### END SMIME dual-key [RSA-PSS] ROOT x509v3_config
EOF
...
### BEGIN SMIME dual-key [RSA-PSS] USER x509v3_config
...
### END SMIME dual-key [RSA-PSS] USER x509v3_config
EOF
