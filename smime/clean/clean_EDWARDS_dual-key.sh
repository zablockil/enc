#!/bin/bash
# key scheme: C + S + E
# faketime "2023-01-01 12:00:00" ./clean_EDWARDS_dual-key.sh
# OpenSSL 1.1.1 and above

test_countryName="US"
test_givenName="Edward"
...
### BEGIN SMIME dual-key [EDWARDS] USER x509v3_config
...
### END SMIME dual-key [EDWARDS] USER x509v3_config
EOF
