...
openssl req -new -x509 -days $root_usage_period_days -$default_md_cert_root -set_serial "0x$(custom_serial)" -config "private/root/config_root.cfg" -key "private/root/key_root.pem" > "private/root/cert_root.crt"
{
...
openssl x509 -req -days $user_usage_period_days -$default_md_cert_user_S -set_serial "0x$(custom_serial)" -in "private/$user_alias/csr_user_S.csr" -CA "private/root/cert_root.crt" -CAkey "private/root/key_root.pem" -extfile "private/$user_alias/config_user.cfg" -extensions x509_smime_DSA_user_S_ext > "private/$user_alias/cert_user_S.crt"
openssl x509 -req -days $user_usage_period_days -$default_md_cert_user_E -set_serial "0x$(custom_serial)" -in "private/$user_alias/csr_user_S.csr" -CA "private/root/cert_root.crt" -CAkey "private/root/key_root.pem" -force_pubkey "private/$user_alias/key_user_E_pub.der" -keyform DER -extfile "private/$user_alias/config_user.cfg" -extensions x509_smime_DH_user_E_ext > "private/$user_alias/cert_user_E.crt"
