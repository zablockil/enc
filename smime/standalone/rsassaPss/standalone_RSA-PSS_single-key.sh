...
# faketime "2024-01-01 12:00:00" ./standalone_RSA-PSS_single-key.sh
...
### END SMIME standalone single-key [RSA-PSS] USER x509v3_config
EOF
...
#
# .   standalone_RSA-PSS_single-key.sh
# |
# +---private
# |   +---root
# |   |       cert_root.crt
